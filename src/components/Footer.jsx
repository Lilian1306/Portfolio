...
const Footer = () => {
  ...
  return (
    <div className=" flex flex-col items-center justify-between px-20 max-sm:px-2 py-2 max-sm:py-2 text-backgroundDark dark:text-textDark bg-textDark dark:bg-backgroundDark backdrop-blur-3xl shadow-sm ">
